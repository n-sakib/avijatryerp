      ...
      <div class="dashboard-container">
       ...
       <?php 
        ...
        <input name="factory_name" type="hidden" value="<?php echo $_POST['factory_name']; ?>">
              <a href="purchase.php" class="btn btn-info pull-right">নতুন ক্রয়</a>
          ...
          <table  cellpadding="1" class="table-condensed table-striped table-bordered table-hover no-margin new table">
            ...
            <?php 
              ...
              foreach($pids as $index => $pid){
                $serial = $index+1;
                $subtotal = convertToEnglishNumber($cost_price[$index])*convertToEnglishNumber($qty[$index])/12;
            ...
            <?php 
              ...
              if(isset($_POST['factory_name'])){
                ...
                $result = mysqli_query($con,"SELECT * FROM purchases WHERE factory_name = '$factory' ORDER BY table_index DESC LIMIT 1");
            ...
            <tr>
              ...
              <td>
                <?php echo $total_amount; ?>
                  ...
                  <input type="hidden" name="curr_due" value="<?php echo $raw_total; ?>">
                  <input type="hidden" name="due" value="<?php echo $total_amount; ?>">
              </td>
            </tr>
            <!--<tr>
              <td></td>
              ...
              <td>জমা</td>
              <td>
                <input type="text" pattern="\d*" name="paid"></td>
            </tr>-->
          </table>
        

        <input class="btn btn-info pull-left" type="submit" value="অনুমোদন" onclick="javascript:newPopup('pid_print.php?memo_no=<?php echo $_POST['memo_no']; ?>');">
