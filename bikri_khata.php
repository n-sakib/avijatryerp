                  ...
                  <div class="span12">
                    <div class="widget">
                      <div class="widget-header">
                        ...
                        <a class="badge badge-mini" href="prev_bikri_khata_req.php">
                          পুরনো খাতা
                        </a>
                      </span>
                      </div>
                      <div class="widget-body" id="bikri-khata">
                        <div class="row-fluid">
...
/*							$result = mysqli_query($con,"SELECT * FROM accounts LIMIT 1");
              ...
              $final_cash = $total_cash - $curr_expense;
				 ...
				 <div class="bikri">
                     ...
                     <!-- comment<option value="staff">স্টাফ</option> -->
                ...
                <div class="row-fluid">
                  <div class="span12">
                    <div class="widget">
                      ...
                      <div class="widget-body" id="tagada-khata">
                        <div class="row-fluid">
