...
<head>
  ...
  <body>
    ...
    <div class="container-fluid">
              ...
              <div class="span12">
                <div class="widget">
                  <div class="widget-header">
                    <div class="title">
                      নতুন খরচ এর প্রোফাইল তৈরি করুন 
                      <span class="mini-title">
                        নতুন প্রোফাইলের সাধারণ ফরম
                      </span>
                    </div>
                    <a class="pull-right label" href="inventory_table/expenses.php">এডিট</a>
      ...
      if(isset($_GET['msg'])){
        if ($_GET['msg']== $success){
          echo '<p class="msg"><h3>খরচ খাত যুক্ত হয়েছে</h3></p>';
        } else{
          echo '<p class="msg"><h3>নামের ঘরটি পূরণ করুন</h3></p>';
        }}else{}
     ?>

                    <form class="form-horizontal no-margin" action="add_new_expense.php" method="post" enctype="multipart/form-data">
                      <div class="control-group">
                        <label class="control-label" for="staff_name">
                          খরচ খাত 
                        </label>
                        <div class="controls controls-row">
                          <input class="span6" name="expense_name" type="text" id="expense_name" onchange="javascript:ifDuplic('expense_name','expense_name','other_expenses');" placeholder="খরচ খাতের নাম দিন">
