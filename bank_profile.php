              ...
              <div class="span6">
                <div class="widget">
                  <div class="widget-header">
                    ...
                    $query = mysqli_query($con,"SELECT * FROM banks WHERE bank_name = '$bank_name' ");
                      echo"<h2>";  
                    ...
                    <a class="pull-right label" href="inventory_table/bankLog.php">এডিট</a>
                  ...
                  <div class="widget-body">
                   ...
                   <tr>
                    ...
                    $query = mysqli_query($con,"SELECT * FROM bank_log WHERE bank_name = '$bank_name' ");
                      ...
                      $result = mysqli_query($con,"SELECT * FROM bank_log ORDER BY table_index DESC LIMIT 1");
