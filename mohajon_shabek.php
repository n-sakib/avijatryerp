                    ...
                    $query = mysqli_query($con,"SELECT * FROM factories WHERE factory_name = '$factory_name' ");
                      ...
                      <div class="widget-body">
                        ...
                        <div class="row-fluid">
                          ...
                          <form method="post" action="mohajon_shabek.php">
                            সাবেক
                            <input name="grand_total" type="text" value="0">
                            তাগাদা
                            <input name="paid" type="text" value="0">
                            <input name="factory" type="hidden" value="<?php echo $factory_name ?>">
