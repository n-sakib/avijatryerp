        ...
        <div class="dashboard-wrapper">
          <div class="left-sidebar">
              ...
              <div class="span6">
                <div class="widget">
                  <div class="widget-header">
                    ...
                    $query = mysqli_query($con,"SELECT * FROM staffs WHERE staff_name = '$staff_name' ");
                       echo"<h2>"; 
                  ...
                  <div class="widget-body">
                   <div class="thumbnail-fix">
                      <img src="<?php echo mb_convert_encoding($row['photo'], "HTML-ENTITIES", "iso-8859-1"); ?>" alt="<?php echo $staff_name; ?>" onclick="newPopup('<?php echo mb_convert_encoding($row['photo'], "HTML-ENTITIES", "iso-8859-1"); ?>');">
                   </div>
                    <div class="profile1">
                          <table class="head">
                            <tr>
            ...
            <?php
              $staff = $_GET['staff'];
              require_once "conn.php";
              $result = mysqli_query($con,"SELECT * FROM staff_log WHERE staff_name = '$staff' ");
              $balance = 0 ;
