    ...
    <div class="container-fluid">
      <div class="dashboard-container">
        ...
        <div class="dashboard-wrapper">
          <!-- <div class="btn pull-right"> <a href="bikri_commission.php">কমিশন</a></div> -->
                  ...
                  <div class="span4">
                    <div class="widget">
                      <div class="widget-header">
                        ...
                        <div class="badge pull-right"><a href="mf_shabek_add.php">সাবেক মাল ফেরত যোগ</a></div>
                      </div>
                      <div class="widget-body">
                        <div class="row-fluid">
                          <table class="table table-bordered no-margin">
                            <colgroup></colgroup>
                            <tr>
                              <th style="width:20%">ক্রমিক নং</th>
                              <th>নাম </th>
                            </tr>
                        <?php
                          ...
                          echo "<tr><td>$serial</td>
                              <td><a href=\"baki_khata_profile.php?client=$row[company_name]\">$row[company_name]</a>
                                    <a class=\"btn btn-primary btn-sm pull-right\" href=\"bikri_commission.php?client=$row[company_name]\">কমিশন</a>
                              </td></tr>";
                            $serial++;
                            }     
                         ?>
