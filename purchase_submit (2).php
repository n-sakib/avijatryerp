  ...
  <body>
    ...
    if(mysqli_num_rows($result)!=0){
      ...
      $memo_no = $last + 1;
        ...
        <input name="memo_no" type="text" value="<?php echo $_POST['memo_no']; ?>
        ">
        <br>
        <label for="factory_name">factory name</label>
        <input name="factory_name" type="text" value="<?php echo $_POST['factory_name']; ?>
        ">
        <br>
          ...
          <table  cellpadding="1" class="table-condensed table-striped table-bordered table-hover no-margin new table">
            ...
            <?php 
              ...
              foreach($genres as $index =>$genre){
                ...
                $description = "$genre_name $type $color";
                ...
                echo "
                    <tr>
                      ...
                      <td>
                        <input type=\"text\" name=\"qtys[]\"  value =\"".$qty[$index]."\"></td>
                      <td>
                        <input type=\"text\" name=\"retail_prices[]\"  value =\"".$retail_price[$index]."\"></td>
                      <td>
                        <input type=\"text\" name=\"cost_prices[]\"  value =\"".$cost_price[$index]."\"></td>
                      <td>
                        <input type=\"text\" name=\"subtotals[]\"  value =\"".$subtotal[$index]."\"></td>
                    </tr>
                    ";
                    array_push($prices, "$subtotal[$index]");
              }
              //calculating total
            ...
            <tr>
              ...
              <td>total</td>
              <td>
                <input type="text" name="total_price"  value ="<?php echo $raw_total; ?>"></td>
            </tr>
            <?php 
              require_once "conn.php";
            ...
            <tr>
              ...
              <td>previous due</td>
              <td>
                <input type="text" name="paid" value="<?php echo $prev_due; ?>"></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
            ...
            <tr>
              ...
              <td>paid</td>
              <td>
                <input type="text" name="paid" value="<?php echo $_POST['paid']; ?>"></td>
            </tr>
            <?php 
                //calculating dues
            ...
            <tr>
              ...
              <td>due</td>
              <td>
                <input type="text" name="due" value="<?php echo $due; ?>"></td>
            </tr>
            <input type="hidden" value="<?php echo $curr_due ; ?>" name="curr_due" ></table>
        </div>
